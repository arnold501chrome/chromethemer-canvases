...
function renderDrawingTopicPage(topicKey) {
  ...
  <head>
    ...
    <style>:root{--bg:#0f1220;--panel:#181b31;--panel2:#1f2442;--text:#f5f7ff;--muted:#b9bfdc;--border:rgba(255,255,255,.08)}*{box-sizing:border-box}body{margin:0;font-family:Inter,Arial,sans-serif;background:linear-gradient(180deg,#0f1220,#13172a);color:var(--text);padding:24px}.wrap{max-width:1260px;margin:0 auto}.nav{display:flex;gap:12px;flex-wrap:wrap;margin-bottom:18px}.btn,.chip{padding:10px 14px;border-radius:999px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.08);color:#fff;text-decoration:none;font-weight:700}.hero{background:linear-gradient(180deg,var(--panel2),var(--panel));border:1px solid var(--border);border-radius:28px;padding:26px;box-shadow:0 18px 48px rgba(0,0,0,.24);margin-bottom:22px}.hero p,.copy p{color:var(--muted);line-height:1.75;max-width:78ch}.grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:20px;align-items:start}.drawing-card{margin:0;background:linear-gradient(180deg,var(--panel2),var(--panel));border:1px solid var(--border);border-radius:24px;overflow:hidden;box-shadow:0 18px 42px rgba(0,0,0,.22);height:auto}.drawing-card__media{display:block;aspect-ratio:16/7.2;overflow:hidden;background:#171c32}.drawing-card__media img{width:100%;height:100%;display:block;object-fit:cover;background:#171c32}.drawing-card__body{padding:14px 16px}.drawing-card__body h2{margin:0 0 8px;font-size:1rem;line-height:1.25}.drawing-card__body h2 a,.drawing-card__links a{color:#fff;text-decoration:none}.drawing-card__body h2 a{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.drawing-card__body p,.drawing-card__meta{color:var(--muted);line-height:1.5}.drawing-card__body p{margin:0 0 8px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.drawing-card__meta{font-size:.95rem}.drawing-card__links{margin-top:8px;line-height:1.45;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.related,.copy{margin-top:22px}.chips{display:flex;flex-wrap:wrap;gap:10px;margin-top:12px}@media (max-width:1100px){.grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media (max-width:720px){body{padding:16px}.grid{grid-template-columns:1fr}.drawing-card__media{aspect-ratio:16/8.8}}</style>
